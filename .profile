export PATH="/Applications/MAMP/bin/php/php8.2.13/bin:${PATH}"
#
# MAMP binaries here only because MAMP adds PHP CLI here
...
alias phpize='/Applications/MAMP/bin/php/php8.2.13/bin/phpize'
alias pear='/Applications/MAMP/bin/php/php8.2.13/bin/pear'
alias peardev='/Applications/MAMP/bin/php/php8.2.13/bin/peardev'
alias pecl='/Applications/MAMP/bin/php/php8.2.13/bin/pecl'
